...
describe('AboutPage', () => {
  ...
  it('renders all section headings', () => {
    ...
    expect(screen.getByRole('heading', { name: 'Adoption Process' })).toBeInTheDocument()
  ...
  it('renders mission statement content', () => {
    ...
    expect(screen.getByText(/providing loving care and finding forever homes/)).toBeInTheDocument()
  })
